...
class UNetModel_MedSegDiffV2(nn.Module):
    ...
    def __init__(
        ...
        self.encoder_2_5d = Generic_UNet(1, 8, ch, 4, conv_op=nn.Conv3d, norm_op=nn.GroupNorm, norm_op_kwargs={'num_groups': 8, 'eps': 1e-5, 'affine': True}, num_conv_per_stage=1)
        self.decoder_2d = Generic_UNet(ch, 8, ch, 4, conv_op=nn.Conv2d, norm_op=nn.GroupNorm, norm_op_kwargs={'num_groups': 8, 'eps': 1e-5, 'affine': True}, num_conv_per_stage=1)
...
class UNetModel_v1preview(nn.Module):
    ...
    def __init__(
        ...
        # --- Conditioning Models ---
        self.hwm = Generic_UNet(self.in_channels - 1, 16, 1, 4, anchor_out=True)
